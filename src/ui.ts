...
function showTitle(): void {
  ...
  title.innerHTML = 'π-TEMPEST<br><span style="font-size:24px;color:#66ccff">Circular Chaos</span>';
  
  const instructions = document.createElement('div');
  instructions.style.fontSize = '18px';
  instructions.style.marginTop = '30px';
  instructions.style.color = '#aaccff';
  instructions.innerHTML = 'Move mouse to position your ship<br>Click to shoot<br><br>Click to Start';
